...
/**
 * bitonic_merge - sort bitonic sequence inside array digits
 * @array: array digits
 * @size: array size
 * @start: starting index sequence array to sort
...
/**
 * bitonic_seq - convert array digits into bitonic sequence
 * @array: array digits
 * @size: array size
 * @start: starting index of block building bitonic sequence
 * @seq: size of block building bitonic sequence
...
/**
 * bitonic_sort - sort array digits in ascending
 * order using bitonic sort algo
 * @array: array digits
 * @size: array size
 *
